...
public final class CityIdDoesNotExistsException extends RuleUCOBETException {
    ...
    public static CityIdDoesNotExistsException create(TelemetryService telemetryService, MessageService messageService){
        var userMessage = messageService.getMessage("M007");
        var technicalMessage = messageService.getMessage("M026");
        return new CityIdDoesNotExistsException(userMessage, technicalMessage, telemetryService, messageService);
    }
