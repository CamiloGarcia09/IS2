...
public final class CountryIdIsDefaultValueException extends RuleUCOBETException {
    ...
    public static CountryIdIsDefaultValueException create(TelemetryService telemetryService){
        var userMessage = MessageHelper.getMessage("M038");
        var technicalMessage = MessageHelper.getMessage("M039");
        return new CountryIdIsDefaultValueException(userMessage, technicalMessage, telemetryService);
    }
}